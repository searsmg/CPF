...
#compile all CSVs
pr_mrms_21 <- list.files(path='/Users/megansears/Documents/MRMS/cpf_2021', full.names = T) %>%
  lapply(read_csv) %>%
  bind_rows

pr_mrms_22 <- list.files(path='/Users/megansears/Documents/MRMS/cpf_2022', full.names = T) %>%
  lapply(read_csv) %>%
  bind_rows
...
write_csv(pr_mrms_21, 'cpf_mrms_21.csv')
write_csv(pr_mrms_22, 'cpf_mrms_22.csv')
